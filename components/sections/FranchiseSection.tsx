    ...
    <section id="franchise" className="relative py-20 md:py-28 overflow-hidden">
      ...
      <div className="relative container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-start">
          ...
          >
            <div className="text-xs font-semibold tracking-[0.18em] uppercase text-[#F5A623] mb-6">
              Why Partner With Us
            </div>
            <div className="space-y-4">
              {benefits.map((b, i) => (
                ...
                >
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[#F5A623]/20 flex items-center justify-center">
