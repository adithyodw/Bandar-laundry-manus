...
export default function HeroSection() {
  return (
    ...
    >
      <Image
        src={HERO_BG}
        alt="Bandar Laundry Express Bali store"
        fill
        priority
      ...
      <div className="relative container pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="max-w-2xl">
          ...
          >
            ...
            <Link href="/#branches" className="btn-outline-white">
              Find Nearest Branch
            </Link>
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-14 flex gap-10 border-t border-white/20 pt-8"
          >
            {[
              ...
              <div key={stat.label}>
                ...
                <div className="text-xs text-white/60 tracking-wide mt-1 uppercase">
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
        <span className="text-white/50 text-xs tracking-widest uppercase animate-pulse">
          Scroll
        </span>
        <svg
          width="16"
